class TareasController < ApplicationController
  ...
  private
    ...
    def tarea_params
      params.require(:tarea).permit(:nombre, :fecha_de_inicio, :fecha_de_continuidad, :duracion_selec, :duracion_dias, :finalizada, :expiracion_selec, :expiracion_dias, :expirada, :componente_id)
    end
end
